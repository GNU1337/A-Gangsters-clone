  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <motion.div 
        ...
        className="w-full max-w-2xl border-4 border-black shadow-[10px_10px_0px_rgba(0,0,0,0.5)] md:shadow-[30px_30px_0px_rgba(0,0,0,0.5)] relative my-auto"
        style={{ backgroundColor: UI_SETTINGS.BG_COLOR_PAPER }}
      >
        {/* Header */}
        <div className="bg-black p-4 md:p-6 flex justify-between items-center">
        ...
        <div className="p-6 md:p-10">
          ...
          <h3 
            className="font-black uppercase mb-4 md:mb-6 border-b-4 border-black pb-2 inline-block text-2xl md:text-4xl"
            style={{ color: UI_SETTINGS.TEXT_COLOR_BLACK, lineHeight: 1 }}
          >
            {step.title}
          </h3>
          <p 
            style={{ fontSize: UI_SETTINGS.BASE_FONT_SIZE, fontWeight: 900 }} 
            className="text-black/80 font-serif leading-relaxed italic mb-8 md:mb-10"
          >
            "{step.content}"
          </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex justify-between w-full md:w-auto md:gap-8 order-2 md:order-1">
              <button 
                onClick={onPrev}
            ...
            <button 
              ...
              className="w-full md:w-auto flex items-center justify-center gap-2 font-black uppercase bg-black text-[#d4af37] px-8 py-4 hover:scale-110 active:scale-95 transition-all shadow-[8px_8px_0px_rgba(212,175,55,0.3)] order-1 md:order-3"
